...
class FrameDiscriminator(nn.Module):
    ...
    def __init__(
        ...
        # Initialize discriminator weights properly to prevent NaN
        self._initialize_weights()
    
    def _initialize_weights(self):
        """Initialize discriminator weights to prevent NaN and ensure stable training."""
        for m in self.modules():
            if isinstance(m, nn.Conv2d):
                ...
                # Initialize final linear layer with smaller weights to prevent extreme outputs
